...
var UsersServices = (function () {
    ...
    UsersServices.prototype.isUserAvailable = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var userExists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._usersRepository.findByUsername(user.username)];
                    case 1:
                        userExists = _a.sent();
    ...
    UsersServices.prototype.create = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var name, username, password, role, id, hashed_password, user, notAvailable;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.isUserAvailable(user)];
                    case 1:
                        notAvailable = _a.sent();
                        if (notAvailable)
                            throw new UsersErrors_1.UserInUseError();
                        return [4, this._usersRepository.add(user)];
                    case 2:
                        _a.sent();
                        return [2, user];
                }
    ...
    UsersServices.prototype.update = function (id, params) {
        return __awaiter(this, void 0, void 0, function () {
            var name, username, password, role, user, notAvailable;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = params.name, username = params.username, password = params.password, role = params.role;
                    ...
                    case 1:
                        ...
                        user.role = role;
                        notAvailable = this.isUserAvailable(user);
                        if (notAvailable)
                            throw new UsersErrors_1.UserInUseError();
                        return [4, this._usersRepository.update(user)];
                    case 2:
                        _a.sent();
                        return [2, user];
                }
    ...
    UsersServices.prototype.updatePassword = function (id, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
