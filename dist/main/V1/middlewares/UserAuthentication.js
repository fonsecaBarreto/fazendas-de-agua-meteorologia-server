...
function AuthenticateUserMiddleware(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var headers, query, token, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!token) return [3, 2];
                    return [4, login_factories_1.authenticationServices.verifyToken(token)];
                case 1:
                    user = _a.sent();
                    if (user) {
                        request.user = user;
