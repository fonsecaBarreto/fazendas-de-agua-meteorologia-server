...
var KnexAdapter = (function () {
    ...
    KnexAdapter.resetMigrations = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, KnexAdapter.connection.migrate.rollback()];
                    case 1:
                        _a.sent();
                        return [4, KnexAdapter.connection.migrate.latest()];
                    case 2:
                        _a.sent();
                        return [2];
                }
    ...
    KnexAdapter.open = function (env) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                KnexAdapter.env = env;
                KnexAdapter.connection = (0, knex_1.default)(knexfile[KnexAdapter.env]);
                return [2];
            });
        });
    };
    KnexAdapter.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, KnexAdapter.connection.destroy()];
                    case 1:
                        _a.sent();
