...
exports.SchemaValidator = exports.makeInvalidMessage = exports.makeMissingMessage = void 0;
...
var SchemaValidator = (function () {
    ...
    SchemaValidator.prototype.validate = function (schema, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                params = {};
                Object.keys(schema.properties).map(function (field) {
                    var type = schema.properties[field].type;
                    var value = body[field];
                    if (value === null) {
                        if (!schema.required.includes(field))
                            return;
                        return params[field] = (0, exports.makeMissingMessage)(field);
                    }
                    var IsTypeValid = _this.checkType(value, type);
                    if (IsTypeValid === false)
                        return params[field] = (0, exports.makeInvalidMessage)(field);
                });
                return [2, Object.keys(params).length > 0 ? params : null];
            });
        });
    };
    SchemaValidator.prototype.sanitize = function (schema, body) {
        Object.keys(body).map(function (param) { if (!schema.properties[param]) {
            delete body[param];
        } });
